...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_e07ed762276864aa, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e07ed762276864aa, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "vanillacoin.vanillacoin.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "vanillacoin.vanillacoin.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("vanillacoin/vanillacoin/tx.proto", fileDescriptor_e07ed762276864aa) }

var fileDescriptor_e07ed762276864aa = []byte{
	// 321 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x28, 0x4b, 0xcc, 0xcb,
	0xcc, 0xc9, 0x49, 0x4c, 0xce, 0xcf, 0xcc, 0xd3, 0x47, 0x66, 0x97, 0x54, 0xe8, 0x15, 0x14, 0xe5,
	...
	0x70, 0x24, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xca, 0x57, 0x17, 0x02, 0x64, 0x02, 0x00,
	0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vanillacoin.vanillacoin.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vanillacoin.vanillacoin.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "vanillacoin.vanillacoin.Msg",
	...
	Metadata: "vanillacoin/vanillacoin/tx.proto",
}
